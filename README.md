Nexus 4 LTE Enabler
===================
This will permanently enable LTE on the Nexus 4 running any Android 5.1 ROM. As long the hybrid radio is present, and a factory reset is not performed, LTE should remain enabled after reboots and ROM flashes.


## What it does
* Flashes .33/1.06 hybrid radio
